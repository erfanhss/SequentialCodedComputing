...
def master():
    ...
    np.savetxt(
        'load_per_iteration_MI_' + str(erasure_prob) + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
            num_epochs) + '.txt',
        np.array(load_per_round))

    np.savetxt(
        'train_acc_per_iteration_MI_' + str(erasure_prob) + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
            num_epochs) + '.txt',
        np.array(train_acc))
    np.savetxt(
        'test_acc_per_iteration_MI_' + str(erasure_prob) + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
            num_epochs) + '.txt',
        np.array(test_acc))
    np.savetxt(
        'result_MI_' + str(erasure_prob) + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(num_epochs) + '.txt',
        np.array(result))
    np.savetxt('straggling_history_MI_' + str(erasure_prob) + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
        num_epochs) + '.txt',
               straggling_history[:, 0:slot])
    np.savetxt('encoding_time_MI_p_' + str(erasure_prob) + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
        num_epochs) + '.txt',
               np.array(encoding_times))
    np.savetxt('decoding_time_MI_p_' + str(erasure_prob) + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
        num_epochs) + '.txt',
               np.array(decoding_times))
    np.savetxt('processing_time_MI_p_' + str(erasure_prob) + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
        num_epochs) + '.txt',
