...
def master():
    ...
    np.savetxt(
        'train_acc_per_iteration_poly_' + 'fritch' + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
            num_epochs) + '.txt',
        np.array(train_acc))
    np.savetxt(
        'train_loss_per_iteration_poly_' + 'fritch' + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
            num_epochs) + '.txt',
        np.array(train_loss))
    np.savetxt(
        'test_acc_per_iteration_poly_' + 'fritch' + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
            num_epochs) + '.txt',
        np.array(test_acc))
    np.savetxt(
        'test_loss_per_iteration_poly_' + 'fritch' + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
            num_epochs) + '.txt',
        np.array(test_loss))
    np.savetxt('result_poly_'+ 'fritch'+'_h1_' + str(h1)+'_h2_'+str(h2)+'_epochs_'+str(num_epochs)+ '.txt',
               np.array(result))
    np.savetxt('encoding_time_poly_'+ 'fritch' +'_h1_'+str(h1)+'_h2_'+str(h2)+'_epochs_'+str(num_epochs)+ '.txt',
               np.array(encoding_times))
    np.savetxt('decoding_time_poly_' + 'fritch' + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
        num_epochs)+ '.txt',
               np.array(decoding_times))
    np.savetxt('processing_time_poly_' + 'fritch' + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
        num_epochs)+ '.txt',
               processing_times[:, 0:slot])
    np.savetxt('load_poly_' + 'fritch' + '_h1_' + str(h1) + '_h2_' + str(h2) + '_epochs_' + str(
        num_epochs) + '.txt',
